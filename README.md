# Video Query Client [![Build Status](https://travis-ci.org/PARC-projects/video-query-client-web.svg?branch=master)](https://travis-ci.org/PARC-projects/video-query-client-web)
